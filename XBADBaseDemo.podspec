...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of XBADBaseDemo."
  ...
  # Or just: spec.author    = "全亮"
  # spec.authors            = { "全亮" => "quanliangani@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/全亮"
